...
Item {
    ...
    focus: true
    implicitHeight: 380
    implicitWidth: 300 // Agregado un ancho por defecto por si acaso
    ...
    // --- ESTILOS PORTADOS (Limpios para end-4) ---
    ...
    // Fondo: Usamos Layer0 o SubSurface segun el tema
    readonly property color colBg: Appearance.colors.colLayer0
    readonly property color colLayer1: Appearance.colors.colLayer1
