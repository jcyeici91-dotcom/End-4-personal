...
Item {
    ...
    property real overlayStrength: Appearance.colors.isDark ? 0.95 : 0.85
    property real iridescenceStrength: 0.04
    ...
    readonly property int rad: customRadius >= 0 ? customRadius : (cornerStyle === 1 ? (Appearance.rounding.windowRounding ?? 18) : 0)
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.00; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.12 : 0.35) }
                GradientStop { position: 0.20; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.03 : 0.08) }
                GradientStop { position: 0.50; color: "transparent" }
                GradientStop { position: 0.80; color: "transparent" }
                GradientStop { position: 1.00; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.05 : 0.20) }
            }
        }
        ...
        Rectangle {
            ...
            color: "transparent"
            border.width: 0.8
            border.color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.06 : 0.20)
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.20; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.40 : 0.70) }
                GradientStop { position: 0.50; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.70 : 0.95) }
                GradientStop { position: 0.80; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.40 : 0.70) }
        ...
        Rectangle {
            ...
            antialiasing: true
            smooth: true
            opacity: root.overlayStrength * 0.80

            gradient: Gradient {
                orientation: Gradient.Horizontal
                GradientStop { position: 0.0; color: "transparent" }
                GradientStop { position: 0.5; color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.25 : 0.50) }
        ...
        Rectangle {
            ...
            color: Qt.rgba(1, 1, 1, root.themeIsDark ? 0.02 : 0.05)
        }
        ...
        ShaderEffect {
            ...
            property real intensity: root.themeIsDark ? 0.12 : 0.20
