...
Item {
    ...
    readonly property string paddedHours: hoursStr.length === 1 ? "0" + hoursStr : (hoursStr || "00")
    ...
    readonly property string dateWeekdayStr: Qt.locale("en_US").toString(new Date(), "dddd")
    ...
    RowLayout {
        ...
        Row {
            ...
            StyledText {
                text: root.vertical ? Qt.locale("en_US").toString(new Date(), "MM/dd") : root.dateNumericStr
                font.family: "Anton, Archivo Black, Arial Black, sans-serif"
                font.pixelSize: Appearance.font.pixelSize.normal
                font.weight: Font.Bold
                color: root.colDateN
