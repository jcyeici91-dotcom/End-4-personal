...
Scope {
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            id: panelWindow
            visible: GlobalStates.dashOpen || content.panelOpacity > 0
            exclusiveZone: 0
            exclusionMode: (content.isHybridNotchMode || content.isDetachedMode) ? ExclusionMode.Ignore : ExclusionMode.Normal
            color: "transparent"
            WlrLayershell.namespace: "quickshell:dashCentral"
            WlrLayershell.layer: GlobalStates.dashOpen ? WlrLayer.Overlay : WlrLayer.Background
            WlrLayershell.keyboardFocus: GlobalStates.dashOpen ? WlrKeyboardFocus.OnDemand : WlrKeyboardFocus.None

            anchors { top: true; bottom: true; left: true; right: true }

            MouseArea {
                anchors.fill: parent
                onClicked: GlobalStates.dashOpen = false
            }

            HyprlandFocusGrab {
                id: focusGrab
                active: GlobalStates.dashOpen && !root.pinned
                windows: [panelWindow]
                onCleared: { if (!root.pinned) GlobalStates.dashOpen = false }
            }
            ...
            Item {
                ...
                Item {
                    ...
                    readonly property bool isDetachedMode: (isTransparentBar && (isFloat || !isHybrid)) || (isFloat && !isTransparentBar && !isHybrid)
                    readonly property bool isHybridNotchMode: isHybrid && !isDetachedMode
                    ...
                    readonly property int detachedGapY: baseBarBottom + 12

                    property int topOvershoot: (isHybridNotchMode || isDetachedMode) ? 0 : 20
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            y: content.isHybridNotchMode ? content.hybridNotchY : (content.isDetachedMode ? content.detachedGapY : 0)
                            ...
                            Rectangle {
                                ...
                                topLeftRadius: content.isDetachedMode ? root.popupRounding : 0
                                topRightRadius: content.isDetachedMode ? root.popupRounding : 0
                                    ...
                                    Item {
                                        ...
                                        Loader {
                                         ...
                                         Loader {
                                            ...
                                            Behavior on opacity { NumberAnimation { duration: 200; easing.type: Easing.OutQuart } }
                                            source: Qt.resolvedUrl("DashCalendario.qml")
                                        }
                                        ...
                                        Loader {
                                         ...
                                         Loader {
                                            ...
                                            Behavior on opacity { NumberAnimation { duration: 200; easing.type: Easing.OutQuart } }
                                            source: Qt.resolvedUrl("DashResources.qml")
                                        }
                        ...
                        RoundCorner {
                            ...
                            color: panelBg.color
                            opacity: 0
                            visible: !content.isDetachedMode
                        }
            ...
            IpcHandler {
                ...
                function close(): void { GlobalStates.dashOpen = false }
                function open(): void {
