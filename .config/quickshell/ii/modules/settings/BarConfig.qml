...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: {
                        if (Config.options.bar.groupBackgroundStyle === "rect") return "rect";
                        if (Config.options.bar.groupBackgroundStyle === "hybrid") return "hybrid";
                        return Config.options.bar.borderless ? "line" : "pills";
                    }
                    ...
                    onSelected: newValue => {
                        if (newValue === "pills") {
                            ...
                            Config.options.bar.groupBackgroundStyle = "rounded"
                        } else if (newValue === "rect") {
                            Config.options.bar.borderless = false
                            Config.options.bar.groupBackgroundStyle = "rect"
                    ...
                    options: [
                        ...
                        { displayName: Translation.tr("Hybrid"), icon: "vertical_align_top", value: "hybrid" },
                        { displayName: Translation.tr("Line"),   icon: "split_scene",        value: "line" }
                    ]
                }
            }
        }
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSpinBox {
                icon: "select_window"
                text: Translation.tr("Max windows per workspace")
        ...
        ConfigSpinBox {
            icon: "touch_long"
            text: Translation.tr("Number delay on Super (ms)")
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSpinBox {
                enabled: !Config.options.bar.vertical && Config.options.bar.mediaPlayer.useCustomSize
                icon: "width_full"
                text: Translation.tr("Lyrics size")
